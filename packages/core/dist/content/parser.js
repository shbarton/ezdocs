...
export function parseMarkdownFile(filePath, collectionName, config) {
...
function estimateReadingTime(wordCount, wordsPerMinute = 200) {
...
export function validateContentItem(item, collectionConfig) {
    const errors = [];
