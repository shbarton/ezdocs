...
export class ExportsGenerator {
  ...
  private generateJSONExport(index: ContentIndex, outputPath: string): void {
  ...
  private generateTypeScriptExport(index: ContentIndex, outputPath: string): void {
    fs.ensureDirSync(dirname(outputPath))
...
export interface ContentIndex {
  ...
  private generateContentExport(index: ContentIndex): string {
